...
-- network backups
DROP TABLE IF EXISTS network_backups_v16;
CREATE TABLE network_backups_v16 (
...
-- Green Power devices
DROP TABLE IF EXISTS gp_devices_v16;
...
CREATE UNIQUE INDEX gp_devices_idx_v16
    ON gp_devices_v16(source_id);


-- Green Power proxy table
DROP TABLE IF EXISTS gp_proxy_table_v16;
CREATE TABLE gp_proxy_table_v16 (
    source_id INTEGER NOT NULL,
    proxy_nwk INTEGER NOT NULL,
...
CREATE UNIQUE INDEX gp_proxy_table_idx_v16
    ON gp_proxy_table_v16(source_id, proxy_nwk);
